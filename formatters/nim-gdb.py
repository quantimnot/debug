# CHANGES:
# - Register more information about the pretty-printers.
#   `info pretty-printer` currently outputs:
#   ```
#   objfile OBJECT_FILE pretty-printers:
#     matcher
#     matcher
#     matcher
#     matcher
...
#     matcher
#   ```
#   Change it so `info pretty-printer` yields:
#   ```
